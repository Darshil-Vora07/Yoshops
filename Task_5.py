...
if Choice[0] == '1':
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_1.pdf') as export_pdf:
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_2.pdf') as export_pdf:
        counts = [45 , 195]
        ig = plt.figure(figsize = (10, 5))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_3.pdf') as export_pdf:
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_4.pdf') as export_pdf:
        fig = plt.figure(figsize =(10, 7))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_5.pdf') as export_pdf:
        ig = plt.figure(figsize = (15, 15))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_6.pdf') as export_pdf:
        ig = plt.figure(figsize = (15, 15))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_7.pdf') as export_pdf:
        ig = plt.figure(figsize = (15, 15))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_8.pdf') as export_pdf:
        fig = plt.figure(figsize =(10, 7))
    ...
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Que_9.pdf') as export_pdf:
    ...
    #Que-10
    with PdfPages(r'C:\Users\khush\Desktop\YoShops\Task-5\Full_Report.pdf') as export_pdf:
        ig = plt.figure(figsize = (10, 5))
        Reviews = ['No Reviews' , '5.0' , '4.0' , '3.0' ,'2.0']
        plt.bar(Reviews, df7['Review_Stars'].value_counts() , color ='green', width = 0.4)
        plt.xlabel("Reviews")
